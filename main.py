...
def main(arguments: List[str]) -> None:
    ...
    plays = download_plays(client, start_date, end_date)
    track_info = download_track_info(client)
    owners = download_owners_info(client)
    payouts = download_payouts_info(client, end_date)
